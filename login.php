...
// check of the user is logged in , if yes then redirect him to the home page
    ...
    if(empty($email) || empty($password)){
        ...
        if($statement->fetch()){
            if(password_verify($password, $stored_password)){
                ...
                // store data in session varibles 
                $_SESSION['id'] = $id;
...
<div class="container py-5">
    <div class="mx-aduto border shadow p-4" style="width: 400px">
